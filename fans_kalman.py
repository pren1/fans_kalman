...
if __name__ == '__main__':
	...
	for (dataline_index, time_line_index) in enumerate(time_line):
		...
		if time_line_index == 0:
			...
			continue
		'At time_line_index-1, the prediction_array contains the prediction in time_line_index'
		diff = abs(prediction_array[time_line_index-1] - input_data[dataline_index])
		diff_list.append(diff)
	...
	axins = zoomed_inset_axes(ax, 200, loc=2)  # zoom-factor: 2.5, location: upper-left
